...
// UpdateLinks is the resolver for the updateLinks field.
func (r *mutationResolver) UpdateLinks(ctx context.Context, input []*model.UpdateLinkInput) ([]*model.Link, error) {
	return r.Srv.UpdateLinks(ctx, input)
}
...
func (r *mutationResolver) DeleteLink(ctx context.Context, id string) (*model.Link, error) {
	return r.Srv.DeleteLink(ctx, id)
}

// DeleteLinks is the resolver for the deleteLinks field.
func (r *mutationResolver) DeleteLinks(ctx context.Context, ids []string) ([]*model.Link, error) {
	return r.Srv.DeleteLinks(ctx, ids)
}
